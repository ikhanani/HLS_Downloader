...
TEST(CacheTest, cache){
  VideoCache cache(100);
  bool duplicate;
  duplicate = cache.checkFile("https://itsvideo.arlingtonva.us:8013/live/cam259.stream", "cdb239db254c3328e38617fd0fd1afab");
  duplicate = cache.checkFile("https://itsvideo.arlingtonva.us:8013/live/cam259.stream", "cdb239db254c3328e38617fd0fd1afab");
  ASSERT_TRUE(duplicate);
  duplicate = cache.checkFile("https://itsvideo.arlingtonva.us:8013/live/cam258.stream", "cdb239db254c3328e38617fd0fd1afab");
